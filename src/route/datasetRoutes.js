...
// Consumer (R3) - View approved datasets
...
// Provider (R2) - Manage own datasets
...
router.post('/approve', auth, checkRole('R1'), datasetController.approveDataset);
router.post('/reject', auth, checkRole('R1'), datasetController.rejectDataset);
