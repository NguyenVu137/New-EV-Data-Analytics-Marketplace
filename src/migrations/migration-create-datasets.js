...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('datasets', {
      ...
      basicPrice: { type: Sequelize.DECIMAL(14, 2), defaultValue: 0 },
      standardPrice: { type: Sequelize.DECIMAL(14, 2), defaultValue: 0 },
      premiumPrice: { type: Sequelize.DECIMAL(14, 2), defaultValue: 0 },
